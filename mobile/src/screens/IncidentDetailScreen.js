        ...
        <View style={styles.mapWrap}>
          ...
          >
            <Marker
              ...
              pinColor={graviteColor(incident.gravite)}
            />
          </MapView>
        </View>
      ) : null}

      {/* Prochaine étape naturelle : un onglet "Chronologie" en rappelant
          GET /incidents/{id}/chronologie. Volontairement omis du scaffold
          pour rester lisible. */}
    </ScrollView>
  );
}
...
const styles = StyleSheet.create({
  ...
  mapWrap: { height: 180, borderRadius: radius, overflow: "hidden", borderWidth: 1, borderColor: colors.border, marginTop: 4 },
  map: { flex: 1 },
